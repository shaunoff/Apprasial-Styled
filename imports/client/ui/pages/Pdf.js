...
export default class Home extends Component {
  ...
  handleClick(){
    ...
    const dummy={
      competencies: {
          employee: {
            ...
            "commComment" : "cccc",
            "coopRating" : 2,
            "coopComment" : "cdhg kjf ghk jfdh gkjdfg hjkd fghkj dfghkj dfghjkd fgh",
            "judgeRating" : 1,
            "judgeComment" : "ccccc",
            "timeRating" : 1,
            "timeComment" : "cccbjklvjbklvbjkljbkljbvkljbvklccc"
        },
        manager : {
                firstName: 'Roger',
                lastName: 'Goudreau',
                "commRating" : 4,
                "commComment" : "jklk hjhjkh hjkh jkhjkh hkjh kjh kjlk",
                "coopRating" : 4,
                "coopComment" : "hkjh hghjg g gh ghj jh ghjkjh",
                "judgeRating" : 1,
                "judgeComment" : "hjhjkhkj hjkh hjkhjk hkjh kjkj hkj hjkhkj hjkhjkh",
                "timeRating" : 4,
                "timeComment" : "hkjhkjh,.mb,mbvmbm,bv,.bv,.kjhkj"
            }
      ...
      achievements: {
        employee: {
          "accompRating" : 1,
          "accompComment" : "employee accomplishments goes here",
          "develRating" : 2,
          "develComment" : "employee proffesional development goes here",
          "goalsRating" : 3,
          "goalsComment" : "employee goals go here"

      },
      manager: {
        "accompRating" : 4,
        "accompComment" : "manager accomplishments goes here",
        "develRating" : 2,
        "develComment" : "manager development goes here",
        "goalsRating" : 1,
        "goalsComment" : "manager goals go here"

    },
      }
    }

    let {employee,manager} = dummy.competencies
    ...
    function section(empComment,manComment,height,empRating,manRating) {
      ...
      doc.text('Shaun wrote:', 12, height+21)
      doc.text(`${manager.firstName} wrote:`, 112, height+21)
    ...
    function summary(empComment,manComment,height,empRating,manRating) {
    ...
    doc.text('Stephanie', 30, 32)
    doc.text('Hutch', 30, 38)
    doc.setTextColor(190,190,190).setFontSize(12).setFontType('normal')
    doc.text('smhutch@p3i-inc.com', 30, 44)
    doc.setTextColor(190,190,190).setFontSize(12).setFontType('normal')
    ...
    doc.text('John Picklesimer', 133, 38)
    doc.text('Lynda Myers', 133, 44)
    ...
    height+=10
    //Achievements
    employee = dummy.achievements.employee
    manager = dummy.achievements.manager
    ...
    summary(employee.goalsComment,manager.goalsComment,180,employee.goalsRating,manager.goalsRating)
    doc.save('67687gg.pdf')
  }
  render() {

    return (
      <div onClick={this.handleClick.bind(this)} style={{padding: '50px'}}>
        jkjklhjlkghfjlkgh
      </div>
    );
  }

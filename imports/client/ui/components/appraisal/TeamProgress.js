...
@Radium
export default class TeamProgress extends React.Component {
  render(){
    const styles={
      section: {
        display: 'flex',
    ...
    <div style={{display: 'flex'}}>
      <div style={[styles.sectionStart]}>
        <div style={styles.subSection}>

          <div style={[styles.circle,section == 1 ? styles.circleActive : styles.circleComplete]}>
            {section == 1 ? <HourGlass size="18px"/> : <img style={{width: '12px'}} src="/icons/checked2.svg"/>}
          </div>
          <div style={[styles.line, section == 1 ? "" : styles.lineComplete]}></div>
        </div>
        <div style={[styles.subtitle,styles.subtitleEnd,styles.subtitleActive]}>
          Self Assessment
        </div>
      </div>
